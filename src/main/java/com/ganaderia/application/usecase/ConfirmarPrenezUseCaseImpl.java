...
public class ConfirmarPrenezUseCaseImpl implements ConfirmarPrenezUseCase {

    private final VacaRepository vacaRepository;
    private final EventPublisher eventPublisher;

    public ConfirmarPrenezUseCaseImpl(VacaRepository vacaRepository, EventPublisher eventPublisher) {
    ...
    public void ejecutar(String vacaId, LocalDate fecha, String observaciones) {
        ...
        vaca.confirmarPrenez(fecha, observaciones);
